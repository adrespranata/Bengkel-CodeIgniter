<?= form_open('pelanggan/hapusall', ['class' => 'formhapus']) ?>
...
<table id="listpelanggan" class="table table-striped dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    ...
    <tbody>
        ...
        foreach ($list as $data) :
            ...
            <tr>
                <td>
                    <input type="checkbox" name="pelanggan_id[]" class="centangPelangganid" value="<?= $data['pelanggan_id'] ?>">
                </td>
                <td><?= $nomor ?></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary btn-sm" onclick="edit('<?= $data['pelanggan_id'] ?>')">
                        <i class="fa fa-edit"></i>
                    </button>
                    <button type="button" class="btn btn-danger btn-sm" onclick="hapus('<?= $data['pelanggan_id'] ?>')">
