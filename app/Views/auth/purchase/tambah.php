...
<div class="card card-default color-palette-box">
    <div class="card-header">
        <button type="button" class="btn btn-warning" onclick="window.location='<?= site_url('purchase/index') ?>'">
...
<script>
        ...
        $('#btnHapusPurchase').click(function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= site_url('purchase/batalPurchase') ?>",
                        type: "post",
                        dataType: "json",
                        data: {
    ...
    function cekKode() {
        ...
        if (kode.length == 0) {
            $.ajax({
                type: "post",
                url: "<?= site_url('purchase/viewDataProduk') ?>",
                dataType: "json",
                success: function(response) {
            ...
            $.ajax({
                type: "post",
                url: "<?= site_url('purchase/tempPurchase') ?>",
                data: {
                    kodebarcode: kode,
    ...
    function dataPurchaseDetail() {
        $.ajax({
            type: "post",
            url: "<?= site_url('purchase/dataDetail') ?>",
            dataType: "json",
            data: {
                nofaktur: $('#nofaktur').val()
            },
    ...
    function pembayaran() {
        ...
        $.ajax({
            type: "post",
            url: "<?= site_url('purchase/pembayaran') ?>",
            dataType: "json",
            data: {
                nofaktur: nofaktur,
    ...
    function hitungTotalBayar() {
        $.ajax({
            url: "<?= site_url('purchase/hitungTotalBayar') ?>",
            dataType: "json",
            type: "post",
            data: {
                nofaktur: $('#nofaktur').val()
