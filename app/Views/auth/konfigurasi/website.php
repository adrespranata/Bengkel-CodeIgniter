        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="form-group text-center">
                    <img class="img-thumbnail logoweb" onclick="logo('<?= $konfigurasi_id ?>')" src="<?= base_url('img/konfigurasi/logo/' . $logo) ?>" width="40%" alt="Foto">
                </div>
            </div>
        </div>
        <div class="card mb-4">
            <div class="card-body">
                ...
                <hr>
                <div class="form-group text-center">
                    <img class="img-thumbnail" onclick="icon('<?= $konfigurasi_id ?>')" src="<?= base_url('img/konfigurasi/icon/'  . $icon) ?>" width="40%" alt="Foto">
                </div>
            </div>
        </div>
    </div>
