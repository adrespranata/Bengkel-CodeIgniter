            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="col-12">
                        ...
                        <input class="form-control" name="username" placeholder="Username" id="username" placeholder="Username" type="text">
                ...
                <div class="form-group">
                    <div class="col-12">
                        ...
                        <input class="form-control" name="password" placeholder="Username" id="password" type="password">
